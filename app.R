...
server <- function(input, output, session) {
  ...
  criar_histograma <- function(dados, variavel, titulo, cor, unidade) {
    ...
    # CORREÇÃO: Garantir que o eixo x reflita os valores reais dos dados
  ...
  # MODIFICAÇÃO: Value boxes - CLOROFILA (3.0m) - ÚLTIMO VALOR
  ...
  # MODIFICAÇÃO: Value boxes - CONDUTIVIDADE (3.0m) - ÚLTIMO VALOR
  ...
  # MODIFICAÇÃO: Value boxes - TEMPERATURA (3.0m) - ÚLTIMO VALOR
  ...
  # MODIFICAÇÃO: Value boxes - OXIGÊNIO (3.0m) - ÚLTIMO VALOR
  ...
  # MODIFICAÇÃO: Value boxes - PAR - ÚLTIMO VALOR
  ...
  output$matriz_correlacao <- renderPlot({
    ...
    # MODIFICAÇÃO: Aumentar tamanho da fonte
    corrplot(mat_cor,
             method = "color",
             type = "upper",
             order = "hclust",
